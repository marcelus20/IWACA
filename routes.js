...
router.get('/api/v2/isAssociatedWithAPlayer/:vocationId', vocationController.isAssociatedWithAPlayer);
router.get('/api/v2/cityIsAssociatedWithAPlayer/:cityId', cityController.cityIsAssociatedWithAPlayer);
